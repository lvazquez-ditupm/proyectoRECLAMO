...
public class SnortSyslogAdapter {
    ...
    public IntrusionAlert parseAlert(String alert, String netMask, String detectionTime) {
        ...
        try {
            ...
            if (message.startsWith("(snort_decoder)")) {
                ...
                String i = path.substring(6, path.length() - 13) + props.getSnortIntrusionClassificationFile();
                ...
                priority = this.obtainIntrusionType(i, priority);
    ...
    private String obtainIntrusionType(String path, String name) {
        String s = null;
        File f = new File(path);
        BufferedReader entrada = null; //new BufferedReader(new InputStreamReader(i));
