    ...
    public  PropsUtil() {
        ...
        try {
           ...
           // is = PropsUtil.class.getResourceAsStream(PARSER_PROPERTIES_FILE);
            ...
            ONTAIRS_DATABASE_NAME_VALUE = parserproperties.getProperty(ONTAIRS_DATABASE_NAME_PROP);
            MYSQL_CONNECTION_USERNAME_VALUE = parserproperties.getProperty(MYSQL_CONNECTION_USERNAME_PROP);
            MYSQL_CONNECTION_PASSWORD_VALUE = parserproperties.getProperty(MYSQL_CONNECTION_PASSWORD_PROP);
            MYSQL_SERVER_NAME_VALUE = parserproperties.getProperty(MYSQL_SERVER_NAME_PROP);
            NETWORK_ASSETS_TABLE_NAME_VALUE = parserproperties.getProperty(NETWORK_ASSETS_TABLE_NAME_PROP);
