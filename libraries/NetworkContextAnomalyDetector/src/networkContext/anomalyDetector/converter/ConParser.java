...
package networkContext.anomalyDetector.converter;
...
public class ConParser {
    public static InfoNetworkAnDetector convertLine(String line){
        ...
        return new InfoNetworkAnDetector(date,duration,eth_proto,ip_proto,portSrc,portDes,src_pkts,dst_pkts,src_bytes,dst_bytes,total_bytes,ipSrc, ipDes, null);
    }
}