/**
 * "ContextAnomalyIndicator" Java class is free software: you can redistribute
...
/**
 * This class represents one specific indicator of the context (network or 
 * system): its name, its value and its weight.
 *  
